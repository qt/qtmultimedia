...
/*!
    ...
    \include qdevice-retains-properties.qdocinc {retains-properties} {QAudioDevice} {QMediaDevices}
...
/*!
    ...
    \include qdevice-retains-properties.qdocinc {retains-properties} {audioDevice} {MediaDevices}
